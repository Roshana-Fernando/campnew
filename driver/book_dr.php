...
<head>
    ...
    <style>
        ...
        .container {
            ...
            margin: 0 auto;
            padding: 20px;
            border: 1px solid rgba(136, 164, 136, 0.8);
            background-color: rgba(126, 147, 117, 0.8);
        }
        h2 {
            text-align: center;
        }
        ...
        select {
            ...
            border-radius: 3px;
            background-color: rgba(182, 216, 182, 0.8);
        }
        input[type="date"],
        input[type="time"],
        select {
...
<body>
    <div class="container">
        <h2><i class="fa fa-taxi"></i> Booking Form</h2>
        ...
        <Div class="form-group">
            ...
            <label for="cab-type">Type:</label>
            <select id="cab-type" name="cab_type" required>
                <option value="standard">Non A/C</option>
                <option value="premium">A/C</option>
            </select>
            </div>
            <input type="text" id="Additional info" name="additional_info" placeholder="Additional info(Additional Stops/ Any request)" required>
           <br>
